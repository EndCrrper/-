...
%x=[1.792186138356053e+02;1.961138441942145e+02;2.287700888258109e+02;2.649997068223830e+02;1.539745823162197]; %fv=3.957753927514420e+02
tic
[x, fv]=SelPSO(@area, 60 ,0.8, 2, 2,[185,205,245,265,10/6],[165,185,225,245,65/60],500,5);
toc
F=[25,x(1),x(2),x(3),x(4),25]; v=x(5);
T=L/v;
S=area(x);
t=0:0.5:T;
k=find(u0==max(u0));
